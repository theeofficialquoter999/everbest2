const {
   ...
   try {
     if (_0x466dd8.reply_message && _0x466dd8.reply_message.groupInvite) {
       ...
       if (_0x29e5fc && _0x29e5fc.includes("joined to:")) {
         return await send(_0x466dd8, "*_Kylie in the house_ 👸❤️🧸*", {}, "", _0x466dd8);
       }
     }
     ...
     await _0x466dd8.error(_0x5d3484 + "\n\ncommand: join", _0x5d3484, "*_Can't Join, Group Id not found, but check if it has requested and is waiting for approval_*");
   }
 });
 smd({
   cmdname: "newgc",
 ...
 smd({
   ...
   try {
     ...
     if (!_0x4ea369 || !_0x4ea369[0]) {
       return await _0xb81e45.reply("*_No Requests Yet, Rest 👸❤️🧸_*");
     }
     let _0x3b870c = [];
 ...
 smd({
   ...
   try {
     ...
     if (!_0x90a6de.isBotAdmin || !_0x90a6de.isAdmin) {
       return await _0x90a6de.reply(!_0x90a6de.isBotAdmin ? "*_I'm Not Admin In This Group, dumbass" + (!_0x90a6de.isCreator ? ", fool" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       _0x160b96.reply("*_✅Group description Updated Successfuly! by Queen_Kylie 👸_*");
     } catch (_0x986809) {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x332d77) {
       return await _0x25d56b.reply("*Uhh idiot, Give text to Update This Group Name*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (_0x4fbd42) {
       ...
       if (!_0x16096e) {
         _0x543a19 = "*❲👑❳ Reason:* _Uhh bitch, Only Group Admin Can Kick Common Users Through This Cmd_\n";
       }
     }
 ...
 cmd({
   ...
   try {
     ...
     try {
       ...
       await _0x118677.reply("*_Ahem, we don't need you anymore... Fuck off, you're rubbish!!_*");
     } catch (_0x5e7b02) {
